...
export async function generateMetadata({
  ...
  const t = await getTranslations({ locale, namespace: "SacredGeometry3Page" })
  const title = "Sacred Geometry III | The Path of Initiation Prague"
...
export default async function SacredGeometryThree({
  params,
}: {
  params: Promise<{ locale: string }>
}) {
